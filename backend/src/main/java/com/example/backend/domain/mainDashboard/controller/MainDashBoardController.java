package com.example.backend.domain.mainDashboard.controller;

import com.example.backend.domain.mainDashboard.dto.MainDashBoardRequestDto;
import com.example.backend.domain.mainDashboard.dto.MainDashBoardResponseDto;
import com.example.backend.domain.mainDashboard.service.MainDashBoardService;
