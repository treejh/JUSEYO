...
export default function LoginPage() {
  ...
  const [loginType, setLoginType] = useState<"manager" | "regular" | null>(
    null
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        (loginType === "manager" && !isManagerRole) ||
        ...
        <div>
          ...
          {step === "select" ? (
            ...
            <form
              ...
              className="shadow-xl rounded-2xl overflow-hidden w-3/4 mx-auto"
            >
              <div className="bg-[#0047AB] text-white px-8 py-6 text-center">
