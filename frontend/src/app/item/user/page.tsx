  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">필요한 비품을 검색하고 요청할 수 있습니다.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="p-4">
                  <div className="text-xs font-medium text-blue-500 mb-1">{item.categoryName}</div>
                  <h3 className="font-medium text-gray-900 mb-2 group-hover:text-blue-500 transition-colors">
                    {item.name}
                  </h3>
                  <div className="flex items-center justify-between mb-3">
                    <div className="text-sm text-gray-600">
                      재고: <span className="font-medium text-blue-500">{item.availableQuantity}</span>
                      <span className="text-gray-400">/{item.totalQuantity}</span>
                    </div>
                    <div className={`px-2 py-1 rounded-full text-xs font-medium ${
                      item.availableQuantity > 0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                    }`}>
