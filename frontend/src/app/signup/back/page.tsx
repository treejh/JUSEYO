...
export default function SignupPage() {
  ...
  const [signupType, setSignupType] = useState<"manager" | "regular" | null>(
    null
  );
  const [hasManagementPage, setHasManagementPage] = useState<boolean | null>(
    null
  );
  const [step, setStep] = useState<
    "select" | "managementSelect" | "signup" | "success"
  >("select");
  ...
  const sendVerificationCode = () => {
    ...
    if (!/^\d{3}-\d{3,4}-\d{4}$/.test(formData.phoneNumber)) {
      setErrors((prev) => ({
        ...prev,
        phoneNumber: "유효한 전화번호 형식이 아닙니다. (예: 010-1234-5678)",
      }));
      return;
    }
  ...
  const verifyCode = () => {
    if (phoneVerification.inputCode === phoneVerification.code) {
      ...
      setErrors((prev) => ({
        ...prev,
        phoneVerification: "인증번호가 일치하지 않습니다.",
      }));
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrors((prev) => ({
          ...prev,
          submit: data.message || "회원가입 중 오류가 발생했습니다.",
        }));
      }
    } catch (error) {
      setErrors((prev) => ({
        ...prev,
        submit: "서버 연결 중 오류가 발생했습니다.",
      }));
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="w-full">
          ...
          {step === "select" ? (
              ...
              <div className="bg-white p-8 flex flex-col items-center">
                ...
                <div className="flex flex-col gap-4 w-full max-w-sm">
                  ...
                  <Link
                    ...
                    } rounded-lg font-medium hover:${
                      signupType === "manager" && hasManagementPage === false
                        ? "bg-blue-50"
                        : "bg-blue-800"
                    } transition-colors text-base gap-2`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
                  ...
                  <Link
                    href="/"
                    className="flex items-center justify-center py-3 px-6 border border-[#0047AB] text-[#0047AB] rounded-lg font-medium hover:bg-blue-50 transition-colors text-base gap-2"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
            ...
            <form
              ...
              className="space-y-1.5 w-full shadow-xl rounded-2xl overflow-hidden"
            >
              ...
              <div className="bg-white px-8 py-5">
                <div className="space-y-1.5">
                  <div className="text-lg font-medium text-[#0047AB] mb-1.5 pb-1.5 border-b border-gray-200">
                    계정 정보
                  </div>
                  ...
                  <div className="mb-2.5">
                    ...
                    <div className="flex mb-1.5">
                      <input
                        className={`flex-grow px-3 py-2.5 border-2 ${
                          errors.email ? "border-red-500" : "border-gray-200"
                        } rounded-lg bg-white text-gray-800 text-base`}
                        type="email"
                        name="email"
                      ...
                      {!emailVerification.verified && (
                        <button
                          type="button"
                          className={`ml-2 px-4 py-2.5 rounded-lg whitespace-nowrap text-base ${
                            emailVerification.verified
                  ...
                  {emailVerification.sent && !emailVerification.verified && (
                    <div className="mb-2.5">
                      <label className="block text-base font-medium text-gray-700 mb-1.5">
                        이메일 인증번호 <span className="text-red-500">*</span>
                      </label>
                      <div className="flex">
                        <input
                          className={`flex-grow px-3 py-2.5 border-2 ${
                          ...
                          onChange={(e) =>
                            handleVerificationCodeChange(e, "email")
                          }
                        />
                        <button
                          type="button"
                  ...
                  {phoneVerification.sent && !phoneVerification.verified && (
                    <div className="mb-2.5">
                      <label className="block text-base font-medium text-gray-700 mb-1.5">
                        휴대폰 인증번호 <span className="text-red-500">*</span>
                      </label>
                      <div className="flex">
                        <input
                          className={`flex-grow px-3 py-2.5 border-2 ${
                          ...
                          onChange={(e) =>
                            handleVerificationCodeChange(e, "phone")
                          }
                        />
                        <button
                          type="button"
                  ...
                  {signupType === "regular" && (
                    <>
                      <div className="text-lg font-medium text-[#0047AB] mt-3 mb-1.5 pb-1.5 border-b border-gray-200">
                        업무 정보
                      </div>
                  ...
                  <div className="bg-gray-50 px-8 py-4 text-center -mx-8 -mb-5 mt-3 border-t border-gray-200">
                    <div className="flex justify-center space-x-6">
                      <Link
                        href="/"
                        className="flex items-center justify-center px-5 py-1.5 border border-[#0047AB] text-[#0047AB] rounded-lg font-medium hover:bg-blue-50 transition-colors text-base"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link
                        href="/login"
                        className="flex items-center justify-center px-5 py-1.5 bg-[#0047AB] text-white rounded-lg font-medium hover:bg-blue-800 transition-colors text-base"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4 mr-1"
